    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 text-center">
                ...
                <h4 class="wow fadeInRight">SuST Society regularly post updates on our Events. Feel free to join with
                    our Community!</h4>
            </div>
        </div>
                ...
                @foreach($dept->event->take(4) as $event)
                    <!-- post item -->
                        <div class="col-lg-3 col-md-3 col-sm-6 post-item wow fadeInUp">
                            <div class="post-img">
                                <a href="{!! route('event.details', $event->event_meta_data ) !!}"><img alt=""
