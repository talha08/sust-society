            ...
            <ul>
                <li data-transition="fade" data-slotamount="1" data-masterspeed="500" data-thumb="{!! URL::asset('frontend/upload/slider_new_02.jpg') !!}"  data-saveperformance="off"  data-title="Slide">
                    ...
                    <div class="tp-caption slider_layer_04 text-center lft tp-resizeme"
                         ...
                         data-endspeed="1000"
                         style="z-index: 9; max-width: auto; max-height: auto; white-space: nowrap;"><strong>{!! $dept->name !!}</strong>
                    </div>
                    ...
                    <div class="tp-caption text-center lft tp-resizeme"
                         ...
                         data-endelementdelay="0.1"
                         data-endspeed="1000"
                         style="z-index: 9; max-width: auto; max-height: auto; white-space: nowrap;"><a target="_blank" href="#" class="btn btn-default">{!! $dept->name !!}</a>
                    </div>
                </li>
