                    ...
                    <div class="fullwidthbanner rslider tp-banner">
                        <ul>
                            ...
                            <li data-transition="fade" data-slotamount="7" data-masterspeed="2000" data-thumb="{!! asset('homeslider_thumb2.jpg') !!}" data-delay="10000"  data-saveperformance="on">
                                <!-- MAIN IMAGE -->
                                <img src="{!! asset('frontend/img/dummy.png') !!}"  alt="laptopmockup_sliderdy" data-lazyload="{!! asset('frontend/img/slider/slider-bg-2.jpg') !!}" data-bgposition="right top" data-kenburns="on" data-duration="12000" data-ease="Power0.easeInOut" data-bgfit="115" data-bgfitend="100" data-bgpositionend="center bottom">
                                <!-- LAYERS -->
                                <!-- LAYER NR. 1 -->
                                ...
                                <div class="tp-caption light_heavy_50 customin fadeout tp-resizeme rs-parallaxlevel-10"
                                    ...
                                    data-endelementdelay="0.1"
                                    data-endspeed="300"
                                    style="z-index: 3; max-width: auto; max-height: auto; white-space: nowrap;"> &nbsp; SOCIETY
                                </div>
                                <!-- LAYER NR. 3 -->
