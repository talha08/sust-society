        ...
        <ul>
            ...
            <li data-transition="fade" data-slotamount="7" data-masterspeed="2000"
                ...
                <div class="tp-caption customin fadeout rs-parallaxlevel-10"
                     ...
                     data-endspeed="300"
                     style="z-index: 2;"><img src="{!! asset('frontend/img/dummy.png') !!}" alt=""
                                              data-lazyload="{!! asset('frontend/img/redbg_big.png') !!}">
                </div>
                <!-- LAYER NR. 2 -->
                <div class="tp-caption light_heavy_50 customin fadeout tp-resizeme rs-parallaxlevel-10"
                     ...
                     data-endelementdelay="0.1"
                     data-endspeed="300"
                     style="z-index: 3; max-width: auto; max-height: auto; white-space: nowrap;"> &nbsp; Application
                </div>
                <!-- LAYER NR. 3 -->
            ...
            <!-- LAYER NR. 5 -->
                ...
                <div class="tp-caption arrowicon customin fadeout rs-parallaxlevel-10"
                     ...
                     data-endelementdelay="0.1"
                     data-endspeed="300"
                     style="z-index: 8;"><img src="{!! asset('frontend/img/dummy.png') !!}" alt="" data-ww="17"
                                              data-hh="17" data-lazyload="{!! asset('frontend/img/check.png') !!}">
                </div>
                <!-- LAYER NR. 8 -->
                <div class="tp-caption black_bold_bg_20 sfr fadeout tp-resizeme rs-parallaxlevel-10"
                     data-x="933"
                ...
                <div class="tp-caption arrowicon customin fadeout rs-parallaxlevel-10"
                     ...
                     data-endelementdelay="0.1"
                     data-endspeed="300"
                     style="z-index: 11;"><img src="{!! asset('frontend/img/dummy.png') !!}" alt="" data-ww="17"
                                               data-hh="17" data-lazyload="{!! asset('frontend/img/check.png') !!}">
                </div>
                <!-- LAYER NR. 11 -->
                <div class="tp-caption black_bold_bg_20 sfr fadeout tp-resizeme rs-parallaxlevel-10"
                ...
                <div class="tp-caption arrowicon customin fadeout rs-parallaxlevel-10"
                     ...
                     data-endelementdelay="0.1"
                     data-endspeed="300"
                     style="z-index: 14;"><img src="{!! asset('frontend/img/dummy.png') !!}" alt="" data-ww="17"
                                               data-hh="17" data-lazyload="{!! asset('frontend/img/check.png') !!}">
                </div>
            </li>
            <!-- /THE FIRST SLIDE -->
            ...
            @foreach($slider as $slide)
                <!-- THE RESPONSIVE SLIDE -->
                    <li data-transition="fade" data-slotamount="1" data-masterspeed="300">
                        <img src="{!! asset($slide->img_url) !!}" data-delay="4000" data-fullwidthcentering="on" alt="">
                        <div class="caption large_text sft"
                             data-x="660"
                             data-y="54"
                             data-speed="300"
                             data-start="800"
                             data-easing="easeOutExpo">{!! $slide->dept->name !!}
                        </div>


                        {{--<div class="caption small_text sft"--}}
                        {{--data-x="600"--}}
                        {{--data-y="280"--}}
                        {{--data-speed="300"--}}
                        {{--data-start="800"--}}
                        {{--data-easing="easeOutExpo"  >{!! str_limit($slide->slider_desc, 400) !!}--}}
                        {{--</div>--}}
                        ...
                        <div class="caption lfl"
                            ...
                            <img src="{!! asset($slide->dept->logo_path) !!}" width="250px" height="200px"
                                 alt="iMac Responsive">
                        </div>
                    </li>
                @endforeach
